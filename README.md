...
Anavi Play pHAT is a simple open source hardware keyboard for Raspberry Pi pHAT (add-on board). Furthermore it supports reading data from various I2S sensor modules. It features:
